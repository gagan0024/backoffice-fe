...
const PlumbingRWHElevated = () => {
  const panelDetails = ["STATION BUILDING"];
  ...
  return (
    <>
      <h2 className="text-xl font-bold mb-4">RWH CALCULATION - ELEVATED</h2>
...
export default PlumbingRWHElevated;
