...
const PlumbingWaterDemandElevated = () => {
  const panelDetails = ["ELEVATED STATION"];
  ...
  return (
    <>
      <h2 className="text-xl font-bold mb-4">WATER DEMAND (ELEVATED)</h2>
...
export default PlumbingWaterDemandElevated;
